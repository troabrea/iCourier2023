...
class TeloAppInfo implements AppInfo {
  ...
  ThemeData getLightTheme() {
    const primaryColor = Color(0xffd96941);
    const secondaryColor = Color(0xff02243d);
    const primaryVariantColor = Color(0xffd96941);
  ...
  ThemeData getDarkTheme() {
    const primaryColor = Color(0xffd96941);
    const secondaryColor = Color(0xffd96941);

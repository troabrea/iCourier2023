...
class BlumBoxAppInfo implements AppInfo {
  ...
  ThemeData getLightTheme() {
    const primaryColor = Color(0xff39B8C0);
    const secondaryColor = Color(0xff534c54);
    const primaryVariantColor = Color(0xff39B8C0);
  ...
  ThemeData getDarkTheme() {
    const primaryColor = Color(0xff39B8C0);
    const secondaryColor = Color(0xff39B8C0);

...
class AtiempoAppInfo implements AppInfo {
  @override
  ...
  ThemeData getLightTheme() {
    const primaryColor = Color(0xff1a3d7a);
    const secondaryColor = Color(0xffc7342c);
  ...
  ThemeData getDarkTheme() {
    const primaryColor = Color(0xffc7342c);
    const secondaryColor = Color(0xff1a3d7a);

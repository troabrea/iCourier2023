...
class AccAppInfo implements AppInfo {
  @override
  FirebaseOptions appFirebaseOptions = AccDefaultFirebaseOptions.currentPlatform;
  ...
  ThemeData getLightTheme() {
    const primaryColor = Color(0xff45a0d6);
    const secondaryColor = Color(0xffd7403d);
    const primaryVariantColor = Color(0xff45a0d6);

    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          ...
          IconButton(iconSize: 30, color: appInfo.metricsPrefixKey == "FIXOCARGO" || appInfo.metricsPrefixKey == "CARGOSPOT" ? Theme.of(context).colorScheme.secondary : Theme.of(context).colorScheme.primary,  alignment: Alignment.topCenter,
              onPressed: () {

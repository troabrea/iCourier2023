...
class _CourierPageState extends State<CourierPage> {
  ...
  FormBuilderTextField buildPasswordFormField(BuildContext context,
      String initialValue) {
  ...
  FormBuilderTextField buildUserAccountFormField(BuildContext context,
      String initialValue) {
    return FormBuilderTextField(
      name: 'user',
      contextMenuBuilder: (context, editableTextState) {
      ...
      decoration: InputDecoration(
        contentPadding: const EdgeInsets.all(2),
        hintText: appInfo.metricsPrefixKey == "CPS"
            ? "ABC-123456"
            : 'codigo_de_cliente'.tr(),
        hintStyle: TextStyle(color: Theme
            .of(context)
            .dividerColor),
        focusedBorder: OutlineInputBorder(
        ...
        prefixIconColor: Theme
            ...
            .dividerColor,
        suffixIcon: GestureDetector(onTap: () {
          _formKey.currentState!.fields['user']!.reset();
        }, child: const Icon(Icons.clear)),
      ),
    );
  }
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: Image.asset(
                          MediaQuery
                              .of(context)
                              .platformBrightness == Brightness.dark ? appInfo
                              .brandLogoImageDark : appInfo.brandLogoImage,
                    ...
                    Center(child: TextButton(onPressed: () async {
                      ...
                      if (userForReset.isNotEmpty && emailForReset.isNotEmpty) {
                        try {
                          ...
                          try {
                            await courierBloc.courierService.resetPassword(
                                userForReset, emailForReset);
                        ...
                        child: Text.rich(TextSpan(
                            text: "lo_olvidaste".tr(), style: Theme
                            .of(context)
                            .textTheme
                            .bodySmall, children: [
                          TextSpan(
                              text: 'recordar_contraseña'.tr(), style: Theme
                              .of(context)
                              .textTheme
                              .bodySmall!
                              .copyWith(
                              color: appInfo.metricsPrefixKey == "FIXOCARGO"
                                  ? Theme
                                  .of(context)
                                  .colorScheme
                                  .secondary
                    ...
                    if(isBusy)
                      Center(
                        child: CircularProgressIndicator(color: GetIt
                            .I<AppInfo>()
                            .metricsPrefixKey == "FIXOCARGO" ? Theme
                            .of(context)
                            .colorScheme
                            .secondary : Theme
                            .of(context)
                    ...
                    if(appInfo.metricsPrefixKey != "INBOX" &&
                        appInfo.metricsPrefixKey != "TUPAQ" &&
                        appInfo.metricsPrefixKey != "FLYPACK" &&
                        appInfo.metricsPrefixKey != "BOXPAQ" &&
                        appInfo.metricsPrefixKey != "SWOOP" &&
                        appInfo.metricsPrefixKey != "FIXOCARGO" &&
                        registerUrl.isNotEmpty)
                      Center(child: TextButton(onPressed: () async {
                        await launchUrlString(
                            registerUrl, mode: LaunchMode.inAppWebView);
                      }, child: Text.rich(TextSpan(
                          text: "no_eres_cliente".tr(), style: Theme
                          .of(context)
                          .textTheme
                          .bodySmall, children: [
                        TextSpan(text: 'conoce_mas_aqui'.tr(), style: Theme
                            .of(context)
                            .textTheme
                            .bodyMedium!
                            .copyWith(color: Theme
                    ...
                    if(appInfo.additionalLocale.isNotEmpty)
                      Row(
                        ...
                        children: [
                          TextButton(onPressed: () {
                            context.setLocale(const Locale('es'));
                          }, child: context.locale.languageCode == 'es'
                              ? Text('Español', style: Theme
                              .of(context)
                              .textTheme
                              .bodyLarge!
                              .copyWith(color: Theme
                              ...
                              .primary, fontWeight: FontWeight.bold),)
                              : const Text('Español'),),
                          Icon(Icons.circle, color: Theme
                              .of(context)
                              .dividerColor, size: 6,),
                          TextButton(onPressed: () {
                            context.setLocale(const Locale('en'));
                          }, child: context.locale.languageCode == 'en'
                              ? Text('English', style: Theme
                              .of(context)
                              .textTheme
                              .bodyLarge!
                              .copyWith(color: Theme
                    ...
                    if(appInfo.metricsPrefixKey == "FIXOCARGO")
                      Center(child: OutlinedButton(onPressed: () async {
                        await launchUrlString("https://fixocargo.com/",
                            mode: LaunchMode.externalApplication);
                      },
                          child: Text.rich(TextSpan(
                            text: "aun_no_eres_cliente".tr(), style: Theme
                              .of(context)
                              .textTheme
                              .bodySmall,
                          )))),
  ...
  Future<void> _showRememberPassword(BuildContext context) async {
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text('recordar_la_contraseña'.tr(), style: Theme
                .of(context)
                .textTheme
                .titleMedium!
                .copyWith(fontWeight: FontWeight.bold),),
            content: SizedBox(height: 160, width: MediaQuery
                .of(context)
                .size
                .width * 0.95,
              child: Column(
                children: [
                  ...
                  if(userForReset.isNotEmpty)
                    Text(userForReset, textAlign: TextAlign.start, style: Theme
                        .of(context)
                        .textTheme
                        .titleMedium,),
                  const SizedBox(height: 20,),
              ...
              TextButton(
                ...
                onPressed: () {
                  if (userForReset.isEmpty || emailForReset.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text(
                        'Debe especificar su cuenta y correo electrónico registrado.',
                        style: Theme
                            .of(context)
                            .textTheme
                            .bodyMedium!
  ...
  onSubmitLogin() async {
    if (_formKey.currentState!.saveAndValidate()) {
      ...
      userName =
          _formKey.currentState!.fields['user']!.value.toString().toUpperCase();
      ...
      if (loginResult.sessionId.isEmpty) {
        ...
        // Previous account let's use it
        GetIt.I<CourierService>().clearCourierDataCache();
        courierBloc.add(UserDidLoginEvent(
            userName, loginResult.sessionId, loginResult.sucursal, loginResult.nombre));
      } else {
        // We have a new session add user account

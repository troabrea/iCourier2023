...
class UserProfileModel {
  ...
  UserProfileModel(
      {required this.empresaId, required this.cuenta, required this.photoUrl});

  Map<String, dynamic> toJson() =>
      {"empresaId": empresaId, "cuenta": cuenta, "photoUrl": photoUrl};
}
...
class PasswordResetModel {
  ...
  PasswordResetModel(
      {required this.empresaId, required this.account, required this.email});

  Map<String, dynamic> toJson() =>
      {"empresaId": empresaId, "account": account, "email": email};
}
